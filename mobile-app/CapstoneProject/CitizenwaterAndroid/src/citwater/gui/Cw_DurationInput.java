/**
 *   Slightly modified version of simpleui.modifiers.v3.M_DurationInput
 * 
 */
...
public abstract class Cw_DurationInput implements ModifierInterface,
		UiDecoratable {
	...
	public Cw_DurationInput(String dateFormatString) {

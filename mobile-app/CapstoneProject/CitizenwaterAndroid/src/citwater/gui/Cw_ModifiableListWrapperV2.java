 ...
 */
public abstract class Cw_ModifiableListWrapperV2<T> implements ModifierInterface {
	...
	public Cw_ModifiableListWrapperV2(Collection<T> initialList, String addButtonText,
	...
	public Cw_ModifiableListWrapperV2(Collection<T> initialList, String addButtonText) {
		...
		items = new ArrayList<Cw_ModifiableListWrapperV2.WrapperItem<T>>();
		if (initialList != null) {
